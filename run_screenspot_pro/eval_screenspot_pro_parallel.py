...
def parse_args():
    ...
    parser.add_argument('--num_gpu', type=int, default=2, help="Number of GPUs to use for parallel processing.")
    parser.add_argument('--max_samples', type=int, default=None, help="Limit to first N samples for testing")
